 ...
 */
class Locatario extends \MyClasses\Entities\Locatario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'id', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'nome', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'sexo', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'nascimento', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'email', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'foneFixo', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'foneCelular', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'cep', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'endereco', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'bairro', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'cidade', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'uf', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'login', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'senha', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'imoveis', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'visitas', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'contratos', '' . "\0" . 'MyClasses\\Entities\\Locatario' . "\0" . 'comentarios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Locatario $proxy) {
